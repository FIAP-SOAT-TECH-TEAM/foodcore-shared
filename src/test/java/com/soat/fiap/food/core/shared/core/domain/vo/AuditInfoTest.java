...
class AuditInfoTest {
    ...
    @Test
    @DisplayName("Deve criar AuditInfo com datas automáticas no construtor default")
    ...
    @Test
    @DisplayName("Deve criar AuditInfo com datas válidas")
    ...
    @Test
    @DisplayName("Não deve permitir updatedAt nulo")
    void shouldThrowExceptionWhenUpdatedAtIsNull() {
        LocalDateTime createdAt = LocalDateTime.now();

        assertThrows(
            NullPointerException.class,
            () -> new AuditInfo(createdAt, null)
        );
    }

    @Test
    @DisplayName("Não deve permitir updatedAt antes de createdAt")
    void shouldThrowBusinessExceptionWhenUpdatedAtIsBeforeCreatedAt() {
        ...
        assertEquals(
            "UpdatedAt não pode ser menor ou igual a CreatedAt",
            exception.getMessage()
        );
    }

    @Test
    @DisplayName("Quando updatedAt for igual a createdAt, deve ajustar automaticamente")
    ...
    @Test
    @DisplayName("Deve permitir atualizar updatedAt para uma data válida")
